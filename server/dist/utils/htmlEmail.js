            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to Crave Food!</h1>
                </div>
                <div class="email-body">
                  <p>Hi ${name},</p>
                  <p>Congratulations! Your email has been successfully verified.</p>
                  <p>We are excited to have you on board at Crave Food. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The Crave Food Team</p>
                </div>
                <div class="email-footer">
                  <p>&copy; 2024 CraveFood. All rights reserved.</p>
                </div>
              </div>
            </body>
          </html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The CraveFood Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 CraveFood. All rights reserved.</p>
            </div>
      ...
      <html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              <p>Hi,</p>
              <p>Use the following OTP to reset your password. This code will expire in 1 hour.</p>
